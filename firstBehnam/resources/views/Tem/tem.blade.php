        ...
        <main>
            ...
            <section class="hero" id="hero">
                <div class="heroText">
                    ...
                    <p class="text-secondary-white-color" data-aos="fade-up" data-aos-delay="1000">
                        Take your <strong class="custom-underline">business</strong> to the next level with us 
                    </p>
                </div>
            ...
            <section class="section-padding pb-0" id="about">
                <div class="container mb-5 pb-lg-5">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="mb-3" data-aos="fade-up">Convert visitors into customers...</h2>
                        </div>

                        <div class="col-lg-6 col-12 mt-3 mb-lg-5">
                            <p class="me-4" data-aos="fade-up" data-aos-delay="300"> You’re a new startup founder or are working on a new software-driven initiative. A mobile app or a responsive web-app is critical to your vision.   </p>
                        </div>

                        <div class="col-lg-6 col-12 mt-lg-3 mb-lg-5">
                            <p data-aos="fade-up" data-aos-delay="500">
                                You’re hearing many development companies explain what they do and why they’re the vendor you should choose; but you’re looking for a partner, not a vendor. We’re here to help. BEHNAM is the top-rated software firm in the Southeast, with a focus on consulting, design, development, and post-launch iteration for newly conceptualized apps and websites.
                            </p>
                        </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-3 col-12 p-0">      
                            <img src="{{asset('assets/images/gogo.jpg')}}" class="img-fluid about-image" alt="">
                        </div>
                            ...
                            <section id="myCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="{{asset('assets/images/people/studio-shot-beautiful-happy-retired-caucasian-female-with-pixie-hairdo-crossing-arms-her-chest-having-confident-look-smiling-broadly.jpg')}}" class="img-fluid team-image" alt="">
                                    ...
                                    <div class="carousel-item">
                                        <img src="{{asset('assets/images/people/project-leder-with-disabilities-looking-front-sitting-immobilized-wheelchair-business-office-room.jpg')}}" class="img-fluid team-image" alt="">
                                    ...
                                    <div class="carousel-item">
                                        <img src="{{asset('assets/images/people/asia-business-woman-feeling-happy-smiling-looking-camera-while-relax-home-office.jpg')}}" class="img-fluid team-image" alt="">
                                    ...
                                    <div class="carousel-item">
                                        <img src="{{asset('assets/images/people/happy-african-american-professional-manager-smiling-looking-camera-headshot-portrait.jpg')}}" class="img-fluid team-image" alt="">
                                    ...
                                    <div class="carousel-item">
                                        <img src="{{asset('assets/images/people/working-business-lady.jpg')}}" class="img-fluid team-image" alt="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="portfolio-thumb mb-5" data-aos="fade-up">
                                <a href="{{asset('assets/images/portfolio/visuals-Y4qzW3AsvqI-unsplash.jpeg')}}" class="image-popup">
                                    <img src="{{asset('assets/images/portfolio/visuals-Y4qzW3AsvqI-unsplash.jpeg')}}" class="img-fluid portfolio-image" alt="">
                                </a>
                            ...
                            <div class="portfolio-thumb" data-aos="fade-up">
                                <a href="{{asset('assets/images/portfolio/severin-candrian-nn3uIZqmUtE-unsplash.jpeg')}}" class="image-popup">
                                    <img src="{{asset('assets/images/portfolio/severin-candrian-nn3uIZqmUtE-unsplash.jpeg')}}" class="img-fluid portfolio-image" alt="">
                                </a>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="portfolio-thumb mt-5 mt-lg-0 mb-5" data-aos="fade-up">
                                <a href="{{asset('assets/images/portfolio/tyler-nix-Y1drF0Y3Oe0-unsplash.jpeg')}}" class="image-popup">
                                    <img src="{{asset('assets/images/portfolio/tyler-nix-Y1drF0Y3Oe0-unsplash.jpeg')}}" class="img-fluid portfolio-image" alt="">
                                </a>
                            ...
                            <div class="portfolio-thumb" data-aos="fade-up">
                                <a href="{{asset('assets/images/portfolio/thought-catalog-gv-T-OjLe4c-unsplash.jpeg')}}" class="image-popup">
                                    <img src="{{asset('assets/images/portfolio/thought-catalog-gv-T-OjLe4c-unsplash.jpeg')}}" class="img-fluid portfolio-image" alt="">
                                </a>
                        ...
                        <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                            <div class="news-thumb" data-aos="fade-up">
                                <a href="news-detail.html" class="news-image-hover news-image-hover-warning">
                                    <img src="{{asset('assets/images/news/caroline-lm-uqveD8dYPUM-unsplash.jpg')}}" class="img-fluid large-news-image news-image" alt="">
                                </a>
                            ...
                            <div class="news-thumb news-two-column d-flex flex-column flex-lg-row" data-aos="fade-up">
                                <div class="news-top w-100">
                                    ...
                                    <a href="news-detail.html" class="news-image-hover news-image-hover-primary">
                                        <img src="{{asset('assets/images/news/jean-philippe-delberghe-MmanXAs1sKw-unsplash.jpeg')}}" class="img-fluid news-image" alt="">
                                    </a>
                            ...
                            <div class="news-thumb news-two-column d-flex flex-column flex-lg-row" data-aos="fade-up">
                                <div class="news-top w-100" data-aos="fade-up">
                                    ...
                                    <a href="news-detail.html" class="news-image-hover news-image-hover-success">
                                        <img src="{{asset('assets/images/news/maria-stewart-p4tj0g-_aMM-unsplash.jpeg')}}" class="img-fluid news-image" alt="">
                                    </a>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-12 mx-auto">
                            ...
                            <h2 class="mb-4 text-center" data-aos="fade-up">Free consulting, write to us</h2>
            ...
            <section class="google-map">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d11190.283269253978!2d9.120095280838232!3d45.47844886561514!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4786c1909e7fc017%3A0x54993b230b18a111!2sSan%20Siro%2C%20Milan%2C%20Metropolitan%20City%20of%20Milan!5e0!3m2!1sen!2sit!4v1679495530320!5m2!1sen!2sit" 
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <a href="mailto:info@behnam.it" class="custom-link mt-3 mb-5">
                            info@behnam.it
                        </a>
                    </div>

                    <div class="col-6">
                        Copyright © BEHNAM 2022
                    </div>
